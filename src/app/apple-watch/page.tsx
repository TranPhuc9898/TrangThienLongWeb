...
export const metadata: Metadata = {
  title:
    "Apple Watch Series 9, Ultra 2, SE - Apple Watch Chính Hãng | Trang Thiên Long",
  description:
    "Mua Apple Watch Series 9, Ultra 2, SE chính hãng giá tốt. Đồng hồ thông minh Apple Watch với tính năng sức khỏe tiên tiến. Bảo hành 12 tháng.",
  keywords: [
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Đồng hồ thông minh Apple Watch với tính năng sức khỏe tiên tiến,
