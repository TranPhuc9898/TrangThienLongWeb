...
export const metadata: Metadata = {
  title: "MacBook Air M2, MacBook Pro, iMac Chính Hãng Giá Rẻ | Trang Thiên Long",
  description: "Mua MacBook Air M2, MacBook Pro M2, iMac 24 inch M1 chính hãng giá tốt. Máy tính Apple với chip M-series mạnh mẽ. Bảo hành 12 tháng, trả góp 0%.",
  keywords: [
    "macbook air m2",
    "macbook pro m2",
    "imac 24 inch",
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Máy tính Apple MacBook Air, MacBook Pro và iMac với chip M-series mạnh mẽ, thiết kế đẹp mắt và hiệu năng vượt trội
          </p>
        </div>
