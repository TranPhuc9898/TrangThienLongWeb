...
const seriesMapping: Record<string, string> = {
  "ipad-pro-m4-series": "iPad Pro M4",
  "ipad-pro-m2-series": "iPad Pro M2",
  "ipad-air-series": "iPad Air",
  "ipad-gen-10-series": "iPad Gen 10",
  "ipad-mini-series": "iPad Mini",
};

export default function iPadSeriesPage({ params }: SeriesPageProps) {
    ...
    const fetchSeriesProducts = async () => {
      try {
        ...
        const filteredProducts = data.filter((p: Product) => {
          ...
          return (
            category.toLowerCase().includes("ipad") &&
            (tag === seriesName ||
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/ipad">iPad</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
      ...
      <section className="relative bg-gradient-to-r from-purple-600 to-blue-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div
    ...
    >
      <div className="relative aspect-square bg-gradient-to-br from-gray-50 to-gray-100 p-6">
        ...
        <div className="relative w-full h-full">
          <Image
            src={product.thumbnail || "/images/ipad/ipad.png"}
            alt={product.productName || "iPad"}
            fill
      ...
      <div className="p-4">
        ...
        <Link
          href={`/${product.slug}`}
          className="w-full bg-purple-600 text-white py-2 rounded-lg font-medium hover:bg-purple-700 transition-colors text-center block text-sm"
        >
          Xem chi tiết
        </Link>
      </div>
