...
export const metadata: Metadata = {
  title: "iPad Chính Hãng Giá Rẻ - iPad Pro, iPad Air, iPad Mini | Trang Thiên Long",
  description: "Mua iPad Pro M2, iPad Air, iPad Mini chính hãng giá tốt nhất. Bảo hành 12 tháng, trả góp 0%. Showroom tại TP.HCM. iPad like new 99% chất lượng cao.",
  keywords: [
    "ipad chính hãng",
    "ipad pro m2", 
    "ipad air 5",
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            iPad Pro M2 mạnh mẽ, iPad Air mỏng nhẹ, iPad thế hệ mới với giá cả cạnh tranh nhất thị trường
          </p>
        </div>
