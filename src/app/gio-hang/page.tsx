      ...
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        {cart && cart.items.length > 0 ? (
              ...
              <div className="w-full lg:max-w-[505px] p-5 md:px-6 flex-col space-y-4 md:space-y-6 rounded-[20px] border border-black/10">
                ...
                <div className="flex flex-col space-y-5">
                  <div className="flex items-center justify-between">
                    <span className="md:text-xl text-black/60">Tạm tính</span>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="md:text-xl font-bold">Miễn phí</span>
                  </div>
                  <hr className="border-t-black/10" />
                  <div className="flex items-center justify-between">
                    <span className="md:text-xl text-black">Tổng cộng</span>
          ...
          <div className="flex items-center flex-col text-gray-300 mt-32">
            ...
            <span className="block mb-4">Giỏ hàng của bạn đang trống.</span>
            <Button className="rounded-full w-32" asChild>
