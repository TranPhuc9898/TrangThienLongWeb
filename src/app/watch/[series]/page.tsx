...
const seriesMapping: Record<string, string> = {
  "apple-watch-series-10-series": "Apple Watch Series 10",
  "apple-watch-series-9-series": "Apple Watch Series 9",
  "apple-watch-ultra-2-series": "Apple Watch Ultra 2",
  "apple-watch-se-series": "Apple Watch SE",
};

export default function WatchSeriesPage({ params }: SeriesPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/apple-watch">Watch</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
      ...
      <section className="relative bg-gradient-to-r from-orange-600 to-red-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div
    ...
    >
      <div className="relative aspect-square bg-gradient-to-br from-gray-50 to-gray-100 p-6">
        ...
        <div className="relative w-full h-full">
          <Image
            src={product.thumbnail || "/images/watch/iwatch.png"}
            alt={product.productName || "Watch"}
            fill
      ...
      <div className="p-4">
        ...
        <Link
          href={`/${product.slug}`}
          className="w-full bg-orange-600 text-white py-2 rounded-lg font-medium hover:bg-orange-700 transition-colors text-center block text-sm"
        >
          Xem chi tiết
        </Link>
      </div>
