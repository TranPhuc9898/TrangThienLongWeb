...
const seriesMapping: Record<string, string> = {
  "macbook-pro-m3-series": "MacBook Pro M3",
  "macbook-air-m3-series": "MacBook Air M3",
  "macbook-air-m2-series": "MacBook Air M2",
  "imac-24-m3-series": 'iMac 24" M3',
};

export default function MacSeriesPage({ params }: SeriesPageProps) {
    ...
    const fetchSeriesProducts = async () => {
      try {
        ...
        const filteredProducts = data.filter((p: Product) => {
          ...
          return (
            (category.toLowerCase().includes("mac") ||
              category.toLowerCase().includes("imac")) &&
            (tag === seriesName ||
        ...
        <div className="max-w-7xl mx-auto px-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/macbook">Mac</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
...
const ProductCard: React.FC<{ product: Product }> = ({ product }) => {
  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] bg-gradient-to-br from-gray-50 to-gray-100 p-6">
        {hasDiscount && (
        ...
        <div className="relative w-full h-full">
          <Image
            src={product.thumbnail || "/images/mac/macbook.png"}
            alt={product.productName || "Mac"}
            fill
      ...
      <div className="p-4">
        ...
        <Link
          href={`/${product.slug}`}
          className="w-full bg-gray-600 text-white py-2 rounded-lg font-medium hover:bg-gray-700 transition-colors text-center block text-sm"
        >
          Xem chi tiết
        </Link>
      </div>
